OC.L10N.register(
    ...
    " entries available within the provided Base DN" : "تەمىنلەنگەن Base DN نىڭ ئىچىدە",
    ...
    "User found and settings verified." : "ئىشلەتكۈچى تېپىلدى ۋە تەڭشەكلەر دەلىللەندى.",
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "تەڭشەكلەر دەلىللەندى ، ئەمما بىردىن كۆپ ئىشلەتكۈچى تېپىلدى. پەقەت بىرىنچىسىلا كىرەلەيدۇ. تېخىمۇ تار سۈزگۈچنى ئويلىشىپ كۆرۈڭ.",
    "An unspecified error occurred. Please check the settings and the log." : "ئېنىقلانمىغان خاتالىق كۆرۈلدى. تەڭشەك ۋە خاتىرىنى تەكشۈرۈپ بېقىڭ.",
    ...
    "A connection error to LDAP / AD occurred, please check host, port and credentials." : "LDAP / AD غا ئۇلىنىش خاتالىقى كۆرۈلدى ، باش ئاپپارات ، پورت ۋە كىنىشكىنى تەكشۈرۈپ بېقىڭ.",
    ...
    "The group box was disabled, because the LDAP / AD server does not support memberOf." : "گۇرۇپپا قۇتىسى چەكلەنگەن ، چۈنكى LDAP / AD مۇلازىمېتىر ئەزاOf نى قوللىمايدۇ.",
    "Server" : "مۇلازىمېتىر",
    "Users" : "ئىشلەتكۈچىلەر",
    "Login Attributes" : "كىرىش خاسلىقى",
    "Groups" : "گۇرۇپپا",
    "The configuration is invalid: anonymous bind is not allowed." : "سەپلىمىسى ئىناۋەتسىز: نامسىز باغلىنىشقا بولمايدۇ.",
    "The configuration is valid and the connection could be established!" : "سەپلىمىسى ئىناۋەتلىك ، ئۇلىنىش ئورنىتىلسا بولىدۇ!",
    "The configuration is valid, but the Bind failed. Please check the server settings and credentials." : "سەپلىمىسى ئىناۋەتلىك ، ئەمما Bind مەغلۇپ بولدى. مۇلازىمېتىر تەڭشىكى ۋە كىنىشكىسىنى تەكشۈرۈپ بېقىڭ.",
    "The configuration is invalid. Please have a look at the logs for further details." : "سەپلىمىسى ئىناۋەتسىز. تېخىمۇ كۆپ تەپسىلاتلار ئۈچۈن خاتىرىلەرنى كۆرۈپ بېقىڭ.",
    ...
    "Verify settings and count groups" : "تەڭشەكلەرنى تەكشۈرۈپ گۇرۇپپىلارنى ساناش",
    ...
    "Allows login against an email attribute. Mail and mailPrimaryAddress will be allowed. WARNING: Disabling login with email might require enabling strict login checking to be effective, please refer to ownCloud documentation for more details!" : "ئېلېكترونلۇق خەت خاسلىقىغا قارشى كىرىشكە يول قويىدۇ. خەت ۋە پوچتا يوللانمىسى ئادرېسىغا رۇخسەت قىلىنىدۇ. ئاگاھلاندۇرۇش: ئېلېكترونلۇق خەت ئارقىلىق كىرىشنى چەكلەشتە قاتتىق كىرىشنى تەكشۈرۈشنىڭ ئۈنۈملۈك بولۇشى تەلەپ قىلىنىشى مۇمكىن ، تېخىمۇ كۆپ تەپسىلاتلار ئۈچۈن ئۆزىڭىزنىڭ Cloud ھۆججىتىنى كۆرۈڭ.",
    ...
    "1. Server" : "1. مۇلازىمېتىر",
    "%s. Server:" : "% s. مۇلازىمېتىر:",
    "Add a new and blank configuration" : "يېڭى ۋە قۇرۇق سەپلىمىنى قوشۇڭ",
    ...
    "Host" : "باش ئاپپارات",
    "Port" : "ئېغىز",
    "You can omit the protocol, except you require SSL. Then start with ldaps://" : "سىز SSL نى تەلەپ قىلغاندىن باشقا ، كېلىشىمنى ئەمەلدىن قالدۇرالايسىز. ئاندىن ldaps دىن باشلاڭ: //",
    "Use StartTLS support" : "StartTLS قوللاشنى ئىشلىتىڭ",
    "Enable StartTLS support (also known as LDAP over TLS) for the connection.  Note that this is different than LDAPS (LDAP over SSL) which doesn't need this checkbox checked. You'll need to import the LDAP server's certificate in your %s server." : "ئۇلىنىش ئۈچۈن StartTLS قوللاشنى قوزغىتىڭ (TLS ئۈستىدىكى LDAP دەپمۇ ئاتىلىدۇ).  شۇنىڭغا دىققەت قىلىڭكى ، بۇ LDAPS (SSL ئۈستىدىكى LDAP) بىلەن ئوخشىمايدۇ ، بۇ تەكشۈرۈش رامكىسى تەكشۈرۈلمەيدۇ. LDAP مۇلازىمېتىرنىڭ گۇۋاھنامىسىنى% s مۇلازىمېتىرىڭىزغا ئەكىرىشىڭىز كېرەك.",
    ...
    "%s access is limited to users meeting these criteria:" : "% s زىيارەت قىلىش بۇ ئۆلچەمگە توشىدىغان ئابونتلار بىلەنلا چەكلىنىدۇ:",
    ...
    "Saving" : "تېجەش",
    "Saved" : "ساقلاندى",
    "<b>Warning:</b> Apps user_ldap and user_webdavauth are incompatible. You may experience unexpected behavior. Please ask your system administrator to disable one of them." : "<b> ئاگاھلاندۇرۇش: </b> ئەپلەر user_ldap ۋە user_webdavauth ماس كەلمەيدۇ. ئويلىمىغان ھەرىكەتلەرنى باشتىن كەچۈرۈشىڭىز مۇمكىن. سىستېما باشقۇرغۇچىڭىزدىن ئۇلارنىڭ بىرىنى چەكلىشىنى تەلەپ قىلىڭ.",
    ...
    "Network Timeout" : "تور ۋاقتى",
    "timeout for all the ldap network operations, in seconds." : "بارلىق ldap تور مەشغۇلاتىنىڭ ۋاقتى ، سېكۇنتتا.",
    ...
    "Each attribute value is truncated to 191 characters" : "ھەر بىر خاسلىق قىممىتى 191 ھەرپكە قىسقارتىلدى",
    ...
    "Group-Member algorithm" : "گۇرۇپپا ئەزالىرىنىڭ ھېسابلاش ئۇسۇلى",
    "Algorithm to be used when searching for members in a group. In case of doubt, \"%s\" is the safe choice. Note that you're responsible of fulfilling the restrictions in order to use any algorithm; the app will behave erratically if the restrictions aren't fulfilled" : "گۇرۇپپىدىكى ئەزالارنى ئىزدىگەندە ئىشلىتىلىدىغان ئالگورىزىم. گۇمانلىق ئەھۋال ئاستىدا ، «% s» بىخەتەر تاللاش. ھەر قانداق ئالگورىزىمنى ئىشلىتىش ئۈچۈن چەكلىمىلەرنى ئورۇنداشقا مەسئۇل ئىكەنلىكىڭىزگە دىققەت قىلىڭ. ئەگەر چەكلىمىلەر ئەمەلگە ئاشمىسا ، ئەپ قالايمىقان ھەرىكەت قىلىدۇ",
    "Scan the group looking for users. This is the basic method and works without restrictions. It supports nested groups" : "ئىشلەتكۈچى ئىزدەۋاتقان گۇرۇپپىنى سايىلەڭ. بۇ ئاساسىي ئۇسۇل بولۇپ ، چەكلىمىسىز ئىشلەيدۇ. ئۇلانغان گۇرۇپپىلارنى قوللايدۇ",
    "Search the members using the \"memberOf\" attribute. It requires support for the \"memberOf\" attribute, and it doesn't work with nested groups" : "ئەزالارنى «memberOf» خاسلىقى ئارقىلىق ئىزدەڭ. ئۇ «memberOf» خاسلىقىنى قوللاشنى تەلەپ قىلىدۇ ، ئۇ ئۇلانغان گۇرۇپپىلار بىلەن ئىشلىمەيدۇ",
    "Search the members using the \"memberOf\" attribute in a recursive way. It requires support for the \"memberOf\" attribute and support for the \"LDAP_MATCHING_RULE_IN_CHAIN\" operator, it works with nested groups. Its main target is AD servers. NOTE: This algorithm only works with members explicitly listed in the group; AD's primary group, for example, won't be taken into account." : "ئەزالارنى قايتا-قايتا «memberOf» خاسلىقى ئارقىلىق ئىزدەڭ. ئۇ «memberOf» خاسلىقىنى قوللاش ۋە «LDAP_MATCHING_RULE_IN_CHAIN» مەشغۇلاتچىسىنى قوللاشنى تەلەپ قىلىدۇ ، ئۇ ئۇۋىغان گۇرۇپپىلار بىلەن ئىشلەيدۇ. ئۇنىڭ ئاساسلىق نىشانى AD مۇلازىمېتىرلىرى. ئەسكەرتىش: بۇ ھېسابلاش ئۇسۇلى پەقەت گۇرۇپپىدا ئېنىق كۆرسىتىلگەن ئەزالار بىلەنلا ئىشلەيدۇ. مەسىلەن AD نىڭ دەسلەپكى گۇرۇپپىسى نەزەرگە ئېلىنمايدۇ.",
