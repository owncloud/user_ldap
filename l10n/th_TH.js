OC.L10N.register(
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "ยืนยันการตั้งค่าแล้ว แต่พบว่าเฉพาะผู้ใช้คนแรกเท่านั้นที่สามารถเข้าสู่ระบบได้ โปรดพิจารณาตัวกรองใหม่",
    "An unspecified error occurred. Please check the settings and the log." : "เกิดข้อผิดพลาดที่ระบุไม่ได้ กรุณาตรวจสอบการตั้งค่าและไฟล์ log ของคุณ",
    ...
    "A connection error to LDAP / AD occurred, please check host, port and credentials." : "เกิดข้อผิดพลาดขณะเชื่อมต่อไปยัง LDAP/AD โปรดตรวจสอบโฮสต์พอร์ตและข้อมูลอื่น ๆ",
    "The %uid placeholder is missing. It will be replaced with the login name when querying LDAP / AD." : "%uid placeholder หายไป มันจะถูกแทนที่ด้วยชื่อที่ใช้เข้าสู่ระบบเมื่อสอบถาม LDAP/AD",
    ...
    "The configuration is invalid. Please have a look at the logs for further details." : "การกำหนดค่าไม่ถูกต้อง สามารถดูไฟล์ log สำหรับรายละเอียดเพิ่มเติม",
    ...
    "Allows login against an email attribute. Mail and mailPrimaryAddress will be allowed. WARNING: Disabling login with email might require enabling strict login checking to be effective, please refer to ownCloud documentation for more details!" : "อนุญาตให้เข้าสู่ระบบโดยใช้แอตทริบิวต์ Mail และ mailPrimaryAddress คำเตือน: การปิดใช้งานการเข้าสู่ระบบด้วยอีเมลอาจต้องเปิดใช้งาน 2FA เพื่อความปลอดภัย สามารถดูรายละเอียดเพิ่มเติมจากเอกสารของ ownCloud!",
    "Other Attributes:" : "คุณลักษณะอื่น ๆ:",
    "Defines the filter to apply, when login is attempted. %%uid replaces the username in the login action. Example: \"uid=%%uid\"" : "กำหนดตัวกรองที่ใช้ เมื่อพยายามเข้าสู่ระบบจะใช้ %%uid แทนชื่อผู้ใช้ในการดำเนินการเข้าสู่ระบบ ตัวอย่าง: \"uid=%%uid\"",
    ...
    "Network Timeout" : "หมดเวลาการเชื่อมต่อกับเครือข่าย",
    "timeout for all the ldap network operations, in seconds." : "หมดเวลาสำหรับการดำเนินการเครือข่าย ldap",
    ...
    "The LDAP attribute that on group objects contains an LDAP search URL that determines what objects belong to the group. (An empty setting disables dynamic group membership functionality.)" : "แอตทริบิวต์ LDAP อยู่ในกลุ่มของวัตถุ ที่ประกอบด้วย URL การค้นหา LDAP ที่\nกำหนดว่าวัตถุอะไรควรอยู่ในกลุ่ม (ตั้งค่าเป็นว่าง เพื่อปิดการใช้งานฟังก์ชั่นสมาชิกกลุ่มแบบไดนามิก)",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "เว้นว่างไว้สำหรับโควต้าเริ่มต้นของผู้ใช้ หรือระบุแอตทริบิวต์ LDAP/AD",
    "Quota Default" : "โควต้าเริ่มต้น",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "แทนที่โควต้าดีฟอลต์สำหรับผู้ใช้ LDAP ใครที่ไม่มีโควต้าให้ตั้งไว้ในฟิลด์โควต้า",
    "Email Field" : "ช่องอีเมล",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "ตั้งค่าอีเมลของผู้ใช้จากแอตทริบิวต์ LDAP เว้นว่างไว้หากต้องการตั้งให้เป็นค่าเริ่มต้น",
