...
"_%s group found_::_%s groups found_" => array("нађена %s група", "нађене %s групе", "нађено %s група"),
"_%s user found_::_%s users found_" => array("нађен %s корисник", "нађена %s корисника", "нађено %s корисника"),
