OC.L10N.register(
    ...
    "Anonymous bind is not allowed. Please provide a User DN and Password." : "A ligação anónima não é permitida. Por favor, forneça um ND de Utilizador e Palavra-passe.",
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "As definições foram verificadas, no entanto foi detetado mais que um utilizador. Apenas o primeiro conseguirá autenticar-se. Considere utilizar um filtro menos abrangente.",
    ...
    "A connection error to LDAP / AD occurred, please check host, port and credentials." : "Ocorreu um erro de ligação a LDAP / AD. Por favor, verifique o anfitrião, porta e credenciais.",
    ...
    "The configuration is valid and the connection could be established!" : "A configuração é válida e a ligação poderá ser estabelecida!",
    "The configuration is valid, but the Bind failed. Please check the server settings and credentials." : "A configuração é válida, mas a ligação falhou. Por favor, verifique as configurações e as credenciais do servidor.",
    "The configuration is invalid. Please have a look at the logs for further details." : "A configuração é inválida. Por favor, consulte os registos para mais detalhes.",
    "Failed to delete the server configuration" : "Erro ao eliminar a configuração do servidor",
    "Failed to clear the mappings." : "A limpeza de mapeamentos falhou.",
    ...
    "Allows login against an email attribute. Mail and mailPrimaryAddress will be allowed. WARNING: Disabling login with email might require enabling strict login checking to be effective, please refer to ownCloud documentation for more details!" : "Permite o logon em um atributo de email. Mail e mailPrimaryAddress serão permitidos. AVISO: Desabilitar o login com e-mail pode exigir a ativação de uma verificação rigorosa de login, consulte a documentação do ownCloud para obter mais detalhes!",
    ...
    "Host" : "Anfitrião",
    "Port" : "Porta",
    "You can omit the protocol, except you require SSL. Then start with ldaps://" : "Pode omitir o protocolo, exceto se precisar de SSL. Então, comece com ldaps://",
    "Use StartTLS support" : "Use o suporte ao StartTLS",
    "Enable StartTLS support (also known as LDAP over TLS) for the connection.  Note that this is different than LDAPS (LDAP over SSL) which doesn't need this checkbox checked. You'll need to import the LDAP server's certificate in your %s server." : "Ative o suporte ao StartTLS (também conhecido como LDAP sobre TLS) para a conexão. Observe que isso é diferente de LDAPS (LDAP sobre SSL), que não precisa dessa caixa de seleção marcada. Você precisará importar o certificado %s do servidor LDAP para o seu servidor.",
    ...
    "You can specify Base DN for users and groups in the Advanced tab" : "Pode especificar a Base ND para os utilizadores e grupos no separador \"Avançado\"",
    ...
    "<b>Warning:</b> The PHP LDAP module is not installed, the backend will not work. Please ask your system administrator to install it." : "<b>Aviso:</b> o módulo LDAP PHP não está instalado, a interface não irá funcionar. Por favor, peça ao administrador do sistema para o instalar.",
    ...
    "Backup (Replica) Host" : "Anfitrião de Cópias de Segurança (Réplica)",
    ...
    "Turn off SSL certificate validation." : "Desativar a validação de certificado SSL.",
    ...
    "in seconds. A change empties the cache." : "em segundos. Uma alteração limpa a cache.",
    "Network Timeout" : "Tempo limite da rede",
    "timeout for all the ldap network operations, in seconds." : "tempo limite para todas as operações de rede do ldap, em segundos.",
    "Directory Settings" : "Definições de Diretoria",
    "User Display Name Field" : "Campo do Nome para Exibir Utilizador",
    ...
    "Each attribute value is truncated to 191 characters" : "Cada valor de atributo é truncado após 191 caracteres",
    ...
    "Group-Member algorithm" : "Algoritmo Membro de Grupo",
    ...
    "Scan the group looking for users. This is the basic method and works without restrictions. It supports nested groups" : "Escaneie o grupo procurando usuários. Este é o método básico e funciona sem restrições. Ele apoia grupos aninhados",
    "Search the members using the \"memberOf\" attribute. It requires support for the \"memberOf\" attribute, and it doesn't work with nested groups" : "Pesquise os membros usando o atributo \"memberOf\". Ele requer suporte para o atributo \"memberOf\", e não funciona com grupos aninhados",
    ...
    "Quota Field" : "Campo de Quota",
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Deixe em branco para a quota predefinida do utilizador. Caso contrário, especifique um atributo LDAP/AD.",
    "Quota Default" : "Quota Predefinida",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Sobrepor quota predefinida para utilizadores LDAP que não têm uma quota definida no campo \"Quota\"",
    "Email Field" : "Campo de E-mail",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Definir o email do utilizador pelo atributo LDAP. Deixar em branco para assumir predefinições.",
    "User Home Folder Naming Rule" : "Regra de Nomeação da Pasta Inicial do Utilizador",
    ...
    "Exposed User Attributes" : "Expor Atributos de  Uuários",
    "User attributes that other apps will be able to check" : "Atributos do usuário que outros aplicativos poderão verificar",
    ...
    "Internal Groupname" : "Nome do Grupo Interno",
    ...
    "Internal Groupname Attribute:" : "Atributos internos do nome do grupo:",
    ...
    "UUID Attribute for Users:" : "Atributo UUID para os utilizadores:",
    "UUID Attribute for Groups:" : "Atributo UUID para os grupos:",
