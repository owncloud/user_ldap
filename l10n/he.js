OC.L10N.register(
    ...
    "By default the internal username will be created from the UUID attribute. It makes sure that the username is unique and characters do not need to be converted. The internal username has the restriction that only these characters are allowed: [ a-zA-Z0-9+_.@- ].  Other characters are replaced with their ASCII correspondence or simply omitted. On collisions a number will be added/increased. The internal username is used to identify a user internally. It is also the default name for the user home folder. It is also a part of remote URLs, for instance for all *DAV services. With this setting, the default behavior can be overridden. To achieve a similar behavior as before ownCloud 5 enter the user display name attribute in the following field. Leave it empty for default behavior. Changes will have effect only on newly mapped (added) LDAP users." : "כברירת מחדל שם המשתמש הפנימי ייווצר ממשתנה ה- UUID. מה שממוודא ששם המשתמש יהיה ייחודי ושתווים אינם נדרשים להיות מוחלפים. לשם המשתמש הפנימי ישנה הגבלה שרק התווים הבאים מורשים : [ a-zA-Z0-9+_.@- ].  תווים אחרים מוחלפים בהתאמת ה- ASCII שלהם או מוסרים לחלוטין. בכל מקרה של התנגשות יוספו/יוגדלו מספרים . שם המשתמש הפנימי משמש לזהות משתמש באופן פנימי בלבד. בנוסף זה שם ברירת המחדל לתיקיית הבית של המשתמש. השם משמש גם כבסיס לנתיב לדוגמא עבור שירותי  *DAV. באמצעות הגדרה זו, ניתן להתעלם מהתנהגות ברירת מחדל זו. להשגת התנהגות דומה ownCloud 5  משתמש בשם התצוגה לשדה זה. יש להשאיר ריק עבור התנהגות ברירת המחדל. השינויים יבואו לידי ביטוי רק עבור משתמשי LDAP ממופים (שנוספו) חדשים.",
