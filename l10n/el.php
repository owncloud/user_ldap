...
"Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." => "Οι ρυθμίσεις επαληθεύτηκαν, αλλά βρέθηκαν περισσότεροι από ένας χρήστες. Μόνο ο πρώτος θα μπορέσει να συνδεθεί. Εξετάστε τη χρήση πιο επιλεκτικού φίλτρο.",
...
"2nd User Display Name Field" => "Πεδίο ονόματος 2ου ονόματος χρήστη",
...
"Override default quota for LDAP users who do not have a quota set in the Quota Field." => "Αντικατάσταση της προεπιλεγμένης ποσόστωσης για χρήστες LDAP που δεν έχουν καθορίσει τη ποσόστωση στο πεδίο Quota.",
