OC.L10N.register(
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Nechte prázdné pro uživatelsky výchozí kvótu. V opačném případě specifikujte atribut LDAP/AD.",
    "Quota Default" : "Výchozí kvóta",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Přepsat výchozí kvótu pro uživatele LDAP, kteří nemají kvótu nastavenou v poli Kvóta.",
    "Email Field" : "Pole emailu",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Nastavit uživatelský e-mail z jeho LDAP atributů. Ponechte prázdné pro výchozí chování.",
