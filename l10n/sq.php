...
"Groups" => "Grupe",
"_%s group found_::_%s groups found_" => array("U gjet %s grup","U gjetën %s grupe"),
"_%s user found_::_%s users found_" => array("U gjet %s përdorues","U gjetën %s përdorues"),
