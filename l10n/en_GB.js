OC.L10N.register(
    ...
    "Exposed User Attributes" : "Exposed User Attributes",
    "User attributes that other apps will be able to check" : "User attributes that other apps will be able to check",
