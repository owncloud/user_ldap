OC.L10N.register(
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Einstellungen überprüft, aber mehr als einen Nutzer gefunden.  Nur der Erste kann sich anmelden. Verwende möglicherweise einen engeren Filter.",
    ...
    "Allows login against an email attribute. Mail and mailPrimaryAddress will be allowed. WARNING: Disabling login with email might require enabling strict login checking to be effective, please refer to ownCloud documentation for more details!" : "Erlaubt das Login über das E-Mail Attribut. \"mail\" und \"mailPrimaryAddress\" werden erlaubt sein. ACHTUNG: Um das Login mit der E-Mailadresse zu verhindern, muss neben dem ausschalten des Logins über das E-Mail Attribut auch die strikte Login-Prüfung aktiv sein. Weitere informationen können in der ownCloud Dokumentation gefunden werden!",
    ...
    "Use StartTLS support" : "Benutze StartTLS support",
    ...
    "Search the members using the \"memberOf\" attribute. It requires support for the \"memberOf\" attribute, and it doesn't work with nested groups" : "Suchen Sie die Mitglieder mit dem Attribut \"memberOf\". Das Attribut \"memberOf\" muss unterstützt werden, funktioniert aber nicht mit verschachtelten Gruppen.",
    "Search the members using the \"memberOf\" attribute in a recursive way. It requires support for the \"memberOf\" attribute and support for the \"LDAP_MATCHING_RULE_IN_CHAIN\" operator, it works with nested groups. Its main target is AD servers. NOTE: This algorithm only works with members explicitly listed in the group; AD's primary group, for example, won't be taken into account." : "Durchsuche die Mitglieder rekursiv mithilfe des Attributs „memberOf“. Das Attribut „memberOf“ und der Operator „LDAP_MATCHING_RULE_IN_CHAIN“ müssen unterstützt werden. Verschachtelte Gruppen werden unterstützt. Das Hauptziel sind AD-Server. BEACHTE: Dieser Algorithmus funktioniert mit Mitgliedern, die explizit in einer Gruppe stehen. Die primäre Gruppe von AD wird beispielsweise nicht berücksichtigt.",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Ohne Eingabe wird der Standardwert für den Speicherplatz der Nutzer verwendet. Anderenfalls trage ein LDAP/AD-Attribut ein.",
