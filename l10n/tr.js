OC.L10N.register(
    ...
    "Search the members using the \"memberOf\" attribute in a recursive way. It requires support for the \"memberOf\" attribute and support for the \"LDAP_MATCHING_RULE_IN_CHAIN\" operator, it works with nested groups. Its main target is AD servers" : "Üyeleri \"memberOf\" özniteliğini kullanarak özyinelemeli bir şekilde arayın. \"memberOf\" özniteliği için destek ve \"LDAP_MATCHING_RULE_IN_CHAIN\" operatörü için destek gerektirir, iç içe gruplarla çalışır. Ana hedefi AD sunucularıdır.",
