OC.L10N.register(
    ...
    "No object found in the given Base DN. Please revise." : "Në DN Bazë të dhënë s’u gjet objekt. Ju lutemi, rishikojeni.",
    ...
    "An error occurred. Please check the Base DN, as well as connection settings and credentials." : "Ndodhi një gabim. Ju lutemi, kontrolloni DN-në Bazë, si dhe rregullimet për lidhjen dhe kredencialet.",
    ...
    "Anonymous bind is not allowed. Please provide a User DN and Password." : "S’lejohet bind anonim. Ju lutemi, jepni një DN Përdoruesi dhe Fjalëkalim.",
    "LDAP Operations error. Anonymous bind might not be allowed." : "Gabim Veprimesh LDAP. Mund të mos lejohen bind-e anonimë.",
    "Saving failed. Please make sure the database is in Operation. Reload before continuing." : "Ruajtja dështoi. Ju lutemi, sigurohuni që baza e të dhënave është në punë. Përpara se të vazhdohet, ringarkojeni.",
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Rregullimet u verifikuan, por u gjet më shumë se një përdorues. Vetëm i pari do të jetë në gjendje të bëjë hyrje. Shihni mundësinë e një filtri më të ngushtë.",
    ...
    "The search filter is invalid, probably due to syntax issues like uneven number of opened and closed brackets. Please revise." : "Filtri i kërkimit është i pavlefshëm, ndoshta për shkak problemesh sintakse, të tillë si një numër jo i njëjtë kllapash të hapura dhe mbyllura. Ju lutemi, rishikojeni.",
    ...
    "Failed to delete the server configuration" : "S’u arrit të fshihet formësimi i shërbyesit",
    "Failed to clear the mappings." : "S’u arrit të hiqen përshoqërimet.",
    "No data specified" : "S’u treguan të dhëna",
    " Could not set configuration %s" : " S’u vu dot në punë formësimin %s",
    ...
    "Test Configuration" : "Provoni Formësimin",
    ...
    "Allows login against the LDAP / AD username, which is either uid or samaccountname and will be detected." : "Lejon hyrje kundrejt emrit të përdoruesit LDAP / AD, që është ose uid, ose samaccountname, dhe do të zbulohet.",
    ...
    "Each attribute value is truncated to 191 characters" : "Çdo vlerë atributi cungohet në 191 shenja",
    ...
    "Group-Member algorithm" : "Algoritëm për Anëtar Grupi",
    "Algorithm to be used when searching for members in a group. In case of doubt, \"%s\" is the safe choice. Note that you're responsible of fulfilling the restrictions in order to use any algorithm; the app will behave erratically if the restrictions aren't fulfilled" : "Algoritëm për t’u përdorur kur kërkohet për anëtarë në një grup. Në rast dyshimi, “%s” është zgjidhja e duhur. Kini parasysh se jeni përgjegjës për plotësimin e kufizimeve, që të mund të përdoret çfarëdo algoritmi; aplikacioni do të sillet çuditshëm, nëse nuk plotësohen kufizimet",
    "Scan the group looking for users. This is the basic method and works without restrictions. It supports nested groups" : "Skanojeni grupin për të parë për përdorues. Kjo është metoda bazë dhe funksionon pa kufizime. Mbulon grupe brenda njëri-tjetrit",
    "Search the members using the \"memberOf\" attribute. It requires support for the \"memberOf\" attribute, and it doesn't work with nested groups" : "Kërkoni anëtarë duke përdorur atributin “memberOf”. Lyp mbulim për atributin “memberOf” dhe nuk funksionon me grupe brenda njëri-tjetrit",
    "Search the members using the \"memberOf\" attribute in a recursive way. It requires support for the \"memberOf\" attribute and support for the \"LDAP_MATCHING_RULE_IN_CHAIN\" operator, it works with nested groups. Its main target is AD servers. NOTE: This algorithm only works with members explicitly listed in the group; AD's primary group, for example, won't be taken into account." : "Kërkoni anëtarë duke përdorur atributin “memberOf” në mënyrë rekursive. Lyp mbulim për atributin “memberOf” dhe mbulim për operatorin “LDAP_MATCHING_RULE_IN_CHAIN”, funksionon me grupe brenda njëri-tjetrit. Objektivi kryesor i tij janë shërbyesit AD. SHËNIM: Ky algoritëm funksionon vetëm me anëtarë të pranishëm shprehimisht te grupi; grupi parësor AD, për shembull, s’do të merrete parasysh.",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Lëreni të zbrazët bosh për kuota parazgjedhje të përdoruesit. Ose përndryshe përcaktoni një atribut LDAP/AD.",
    "Quota Default" : "Parazgjedhje Kuotash",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Anashkalo kuota parazgjedhje për përdorues LDAP të cilët nuk kanë të caktuar ndonjë kuotë te fusha Kuota.",
    "Email Field" : "Fushë Email-i",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Plotëso email përdoruesi prej atributit të tyre LDAP. Lëreni të zbrazët që të zbatohet sjellja parazgjedhje.",
    "User Home Folder Naming Rule" : "Rregull Emërtimi Dosjeje Kreu të Përdoruesit",
    "Leave empty for user name (default). Otherwise, specify an LDAP/AD attribute." : "Për emrin e përdoruesit, lëreni të zbrazët (parazgjedhje). Përndryshe, përcaktoni një atribut LDAP/AD.",
    "Exposed User Attributes" : "Atribute të Ekspozuara Përdoruesi",
    "User attributes that other apps will be able to check" : "Atribute përdoruesi që aplikacione të tjera do të jenë në gjendje t’i shohin",
    "Internal Username" : "Emër i Brendshëm Përdoruesi",
    "By default the internal username will be created from the UUID attribute. It makes sure that the username is unique and characters do not need to be converted. The internal username has the restriction that only these characters are allowed: [ a-zA-Z0-9+_.@- ].  Other characters are replaced with their ASCII correspondence or simply omitted. On collisions a number will be added/increased. The internal username is used to identify a user internally. It is also the default name for the user home folder. It is also a part of remote URLs, for instance for all *DAV services. With this setting, the default behavior can be overridden. To do so, enter the user display name attribute in the following field. Leave it empty for default behavior. Changes will have effect only on newly mapped (added) LDAP users." : "Si parazgjedhje, emri i brendshëm i përdoruesit do të krijohet prej atributit UUID. Kjo siguron që emri i përdoruesit të jetë unik dhe të mos jetë e nevojshme të shndërrohen shenjat që e përbëjnë. Emri i brendshëm i përdoruesit ka kufizimin që për të lejohen vetëm këto shenja: [ a-zA-Z0-9+_.@- ]. Shenjat e tjera zëvendësohen me shenjën përgjegjëse në ASCII ose thjesht lihen pa u vënë. Kur ka përplasje, do të shtohet/rritet një numër. Emri i brendshëm i përdoruesit përdoret për ta identifikuar një përdorues së brendshmi. Është gjithashtu emri parazgjedhje për dosjen Home të përdoruesit. Është gjithashtu pjesë e URL-ve të largëta, për shembull, për krejt shërbimet *DAV. Me këtë rregullim mund të anashkalohet sjellja parazgjedhje. Për të bërë këtë, jepni atributin emër përdoruesi në ekran te fusha vijuese. Lëreni të zbrazët, që të ruhet sjellja parazgjedhje. Ndryshimet do të kenë efekt vetëm mbi përdorues LDAP të përshoqëruar (shtuar) rishtas.",
    "Internal Username Attribute:" : "Atribut Emër i Brendshëm Përdoruesi:",
    "Internal Groupname" : "Emër i Brendshëm Grupi",
    "The internal groupname is used to uniquely identify the group. It has the same restrictions as the internal username, in particular, the group name must be immutable and unique. By default, the UUID will be used. This internal groupname won't likely by visible because a displayname attribute is intended to be used to show the group." : "Emri i brendshëm i grupit përdoret për të identifikuar në mënyrë unike grupin. Ka të njëjtat kufizime si emri i brendshëm i përdoruesit, në veçanti, emri i grupit duhet të jetë i pandryshueshëm dhe unik. Si parazgjedhje, përdoret UUID. Ka shumë mundësi që ky emër i brendshëm grupi s’do të jetë i dukshëm, ngaqë për të shfaqur grupin është menduar një atribut “displayname”.",
    "Internal Groupname Attribute:" : "Atribut Emri të Brendshëm Grupi:",
    "Override UUID detection" : "Anashkalo zbulim UUID-je",
