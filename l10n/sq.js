OC.L10N.register(
    ...
    "Leave empty for user name (default). Otherwise, specify an LDAP/AD attribute." : "Lëreni të zbrazët për emrin e përdoruesit (parazgjedhje). Përndyshe, përcaktoni një atribut LDAP/AD.",
