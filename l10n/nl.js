OC.L10N.register(
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Instellingen geverifieerd, maar meer dan één gebruiker gevonden. Alleen de eerste kan inloggen. Overweeg een krapper filter.",
    ...
    "Host" : "Host",
    "You can omit the protocol, except you require SSL. Then start with ldaps://" : "U kunt het protocol weglaten, tenzij u SSL vereist. Start in dat geval met ldaps://",
    "Port" : "Poort",
    "User DN" : "User DN",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Laat leeg voor gebruik van het standaardquotum voor de gebruiker. Of, specificeer een LDAP/AD attribuut.",
    "Quota Default" : "Quota standaard",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Forceer de standaard quota voor LDAP gebruikers die geen quotum ingesteld hebben in het Quotum veld.",
    "Email Field" : "E-mailveld",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Stel het email adres voor de gebruiker in op basis van het LDAP attribute. Laat leeg voor standaard gedrag.",
