OC.L10N.register(
    ...
    "Testing configuration…" : "Tèst de configuracion...",
    ...
    "%s access is limited to users meeting these criteria:" : "L'accès a %s es limitat als utilizaires que validan aquestes critèris :",
    ...
    "2nd User Display Name Field" : "Segond atribut pel nom d'afichatge",
    "Optional. An LDAP attribute to be added to the display name in brackets. Results in e.g. »John Doe (john.doe@example.org)«." : "Opcional. Atribut LDAP d'apondre al nom d'afichatge, entre parentèsis. Aquò donarà per exemple : \"John Doe (john.doe@example.com)\".",
    ...
    "The LDAP attribute that on group objects contains an LDAP search URL that determines what objects belong to the group. (An empty setting disables dynamic group membership functionality.)" : "L'atribut LDAP dels objèctes gropes que conten l'URL de recèrca LDAP que determina quines objèctes apartenon al grop. (Un atribut void desactiva la foncionalitat de gropes dinamics)",
