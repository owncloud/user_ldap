...
"The configuration is invalid. Please have a look at the logs for further details." => "การกำหนดค่าไม่ถูกต้อง สามารถดูไฟล์ logs สำหรับรายละเอียดเพิ่มเติม",
...
"Groups" => "กลุ่ม",
"_%s group found_::_%s groups found_" => array("พบ %s กลุ่ม"),
"_%s user found_::_%s users found_" => array("พบผู้ใช้ %s คน"),
