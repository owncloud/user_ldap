OC.L10N.register(
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Innstillinger er verfifisert men flere en en bruker er funnet. Kun den første vil kunne logge inn. Vurder å snevre inn med filtrering.",
    ...
    "Each attribute value is truncated to 191 characters" : "Hver attributt sin verdi er forkortet til 191 tegn",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "La stå tomt for brukerens standardkvote. Ellers, angi en LDAP/AD-attributt.",
    "Quota Default" : "Standard lagringskvote",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Overstyr standard kvote for LDAP-brukere som ikke har en kvote satt i Kvote-feltet.",
    "Email Field" : "Felt med e-postadresse",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Sett brukernes e-post fra deres LDAP-attributt. La stå tomt for standard oppførsel.",
