OC.L10N.register(
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Les paramètres ont été vérifiés, mais plus d'un utilisateur ont été trouvés. Seul le premier d'entre eux sera autorisé à se connecter. Pensez à définir un filtre plus fin. ",
    ...
    "Use StartTLS support" : "Utilisez le support StartTLS.",
    ...
    "Network Timeout" : "Délai d'attente du réseau  dépassé.",
    ...
    "Each attribute value is truncated to 191 characters" : "Chaque valeur d'attribut est tronquée à 191 caractères",
    ...
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Passer outre le quota par défaut pour les utilisateurs LDAP qui n'ont pas défini de quota dans le champ Quota",
    "Email Field" : "Champ Email",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Définir l'adresse courriel de l'utilisateur d'après ses informations issues de LDAP. Laisser vide pour utiliser le comportement par défaut.",
