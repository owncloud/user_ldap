OC.L10N.register(
    ...
    "Testing configuration…" : "Test nastavenia…",
    ...
    "More than 1,000 directory entries available." : "Dostupných viac ako 1000 položiek adresára.",
    ...
    "%s access is limited to users meeting these criteria:" : "Prístup k %s je obmedzený na používateľov spĺňajúcich tieto kritériá:",
    ...
    "2nd User Display Name Field" : "Pole na zobrazenia mena druhého používateľa",
    "Optional. An LDAP attribute to be added to the display name in brackets. Results in e.g. »John Doe (john.doe@example.org)«." : "Voliteľné. Atribút LDAP, ktorý sa má pridať k zobrazovanému menu do zátvoriek. Výsledok vyzerá napr. takto: „John Doe (john.doe@example.org)“.",
    ...
    "The LDAP attribute that on group objects contains an LDAP search URL that determines what objects belong to the group. (An empty setting disables dynamic group membership functionality.)" : "Atribút LDAP, ktorý na objektoch skupiny obsahuje vyhľadávacie URL LDAP, ktoré určuje objekty patriace do skupiny. (Prázdne nastavenie vypne funkciu dynamického členstva v skupine.)",
