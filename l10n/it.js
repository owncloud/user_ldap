OC.L10N.register(
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Impostazioni verificate, ma è stato trovato più di un utente. Solo il primo potrà loggarsi. Considera un filtri più stretto",
    ...
    "Use StartTLS support" : "Usa il supporto di StartTLS",
    "User DN" : "DN utente",
    ...
    "Network Timeout" : "Timeout di rete",
    "timeout for all the ldap network operations, in seconds." : "timeout per tutte le operazioni di rete ldap, in secondi.",
    ...
    "Each attribute value is truncated to 191 characters" : "Ogni valore di attributo è troncato a 191 caratteri",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Lasciare vuoto per usare la quota normale per l'utente. Altrimenti, specificare un attributo LDAP/AD.",
    "Quota Default" : "Quota predefinita",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Cambia il valore normale di quota per gli utenti LDAP che non hanno una quota definite nel Campo Quota.",
    "Email Field" : "Campo Email",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Imponi la mail dell'utente dal loro attributo LDAP. Lasciare vuoto per comportamento normale",
