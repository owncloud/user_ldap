OC.L10N.register(
    ...
    "Testing configuration…" : "Tester konfigurationen...",
    ...
    "Settings verified, but more than one user was found. Only the first will be able to login. Consider a more narrow filter." : "Indstillinger verificeret, men der blev fundet mere end én bruger. Kun den første vil kunne logge in. Overvej et smallere filter.",
    ...
    "%s access is limited to users meeting these criteria:" : "%s adgangen er begrænset til brugere som imødekommer disse kriterier:",
    ...
    "2nd User Display Name Field" : "2. Vist brugernavn felt",
    "Optional. An LDAP attribute to be added to the display name in brackets. Results in e.g. »John Doe (john.doe@example.org)«." : "Valgfri. En LDAP-attribut der skal lægges til det viste navn i parentes. Resulterer f.eks i »John Doe (john.doe@example.org)«.",
    ...
    "Each attribute value is truncated to 191 characters" : "Hver egenskabsværdi er begrænset til 191 karakterer",
    ...
    "Dynamic Group Member URL" : "Dynamisk Gruppe Medlem URL",
    "The LDAP attribute that on group objects contains an LDAP search URL that determines what objects belong to the group. (An empty setting disables dynamic group membership functionality.)" : "LDAP attributten, der på gruppe objekter indeholder en LDAP søge URL, der bestemmer hvilke objekter der hører til gruppen. (En tom indstilling deaktiverer Dynamisk Gruppe Medlemskabs-funktionalitet.)",
    ...
    "Leave empty for user's default quota. Otherwise, specify an LDAP/AD attribute." : "Efterlad tom for brugerens standardkvota. Ellers, specificer en LDAP/AD attribut.",
    "Quota Default" : "Standard for kvota",
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "Overskriv standardkvota for LDAP-brugere, der ikke har et instillet kvotum i Kvota-felt.",
    "Email Field" : "Felt for e-mail",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Set brugens email fra deres LDAP-instilling. Efterlad tom for standardopførsel.",
