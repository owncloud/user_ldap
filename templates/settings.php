	...
	<fieldset id="ldapSettings-1">
		<div id="ldapAdvancedAccordion">
			...
			<div>
				...
				<p><label for="ldap_medial_searches"><?php p($l->t('Medial Searches'));?></label><input type="checkbox" id="ldap_medial_searches" name="ldap_medial_searches" value="1" data-default="<?php p($_['use_medial_searches_default']); ?>"  title="<?php p($l->t('By default, the searches for users or groups will take into account only the beginning of the string (if you search "al", "alice" will be found, but not "balnar"). Medial searches allows matching in any part of the string (in the previous example, both names would match). Note that some indexes might need to be added in some LDAP servers in order to give a good performance in big installations'));?>" /></p>
